{
  ...
  outputs =
    ...
    flake-parts.lib.mkFlake { inherit inputs; } (
      ...
      let
        import-all = import ./import-all.nix { inherit lib inputs; };
      in
      {
        systems = [
          "x86_64-linux"
        ...
        # Each <name>.mod.nix file anywhere in ./modules becomes .#nixosModules.<name>
        flake.nixosModules = import-all "mod";

        # Each <name>.hm.nix file anywhere in ./modules becomes .#homeModules.<name>
        flake.homeModules = import-all "hm";
