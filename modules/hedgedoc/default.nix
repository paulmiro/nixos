  ...
  flake.nixosModules.hedgedoc =
    ...
    in
    {
      options.paul.hedgedoc = {
        ...
        domain = lib.mkOption {
          type = lib.types.str;
          default = self.private.domains.hedgedoc;
      ...
      config = lib.mkIf cfg.enable {
        services.hedgedoc = {
          ...
          settings = {
            ...
            email = false;
            oauth2 = {
              baseUrl = "https://${self.private.domains.kanidm}";
              providerName = self.private.misc.kanidm_display_name;
              clientID = "hedgedoc";
              clientSecret = "$OAUTH2_CLIENT_SECRET";
              scope = "openid email profile";
              userProfileURL = "https://${self.private.domains.kanidm}/oauth2/openid/hedgedoc/userinfo";
              tokenURL = "https://${self.private.domains.kanidm}/oauth2/token";
              authorizationURL = "https://${self.private.domains.kanidm}/ui/oauth2";
