    ...
    config =
      lib.mkIf config.enableAuthentik {
        ...
        locations."/outpost.goauthentik.io".extraConfig = ''
          proxy_pass              https://auth.${builtins.readFile ../../secrets/domains/_base_old}/outpost.goauthentik.io;
        ...
        locations."@goauthentik_proxy_signin".extraConfig = ''
          ...
          # return 302 https://auth.${builtins.readFile ../../secrets/domains/_base_old}/outpost.goauthentik.io/start?rd=$scheme://$http_host$request_uri;
        '';
      };
  };
in
{
  ...
  options.paul.authentik = {
    ...
    domain = mkOption {
      type = types.str;
      default = "auth.${builtins.readFile ../../secrets/domains/_base_old}";
