...
in
{
  options.paul.hedgedoc = {
    ...
    domain = lib.mkOption {
      type = lib.types.str;
      default = private.domains.hedgedoc;
  ...
  config = lib.mkIf cfg.enable {
    services.hedgedoc = {
      ...
      settings = {
        ...
        email = false;
        oauth2 = {
          baseUrl = "https://${private.domains.kanidm}";
          providerName = private.misc.kanidm_display_name;
          clientID = "hedgedoc";
          clientSecret = "$OAUTH2_CLIENT_SECRET";
          scope = "openid email profile";
          userProfileURL = "https://${private.domains.kanidm}/oauth2/openid/hedgedoc/userinfo";
          tokenURL = "https://${private.domains.kanidm}/oauth2/token";
          authorizationURL = "https://${private.domains.kanidm}/ui/oauth2";
