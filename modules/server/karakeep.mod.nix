...
in
{
  options.paul.karakeep = {
    ...
    domain = lib.mkOption {
      type = lib.types.str;
      default = private.domains.karakeep;
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.karakeep = {
      ...
      extraEnvironment = {
        ...
        OAUTH_WELLKNOWN_URL = "https://${private.domains.kanidm}/oauth2/openid/karakeep/.well-known/openid-configuration";
        OAUTH_PROVIDER_NAME = private.misc.kanidm_display_name;
