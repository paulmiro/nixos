    ...
    in
    {
      options.paul.outline = {
        ...
        domain = lib.mkOption {
          ...
          type = lib.types.str;
          default = "outline.${self.private.domains.base}";
        };
      };
      ...
      config = lib.mkIf cfg.enable {
        ...
        systemd.services.outline = {
          ...
          environment = {
            ...
            OIDC_ISSUER_URL = "https://${self.private.domains.kanidm}/oauth2/openid/outline";
            OIDC_USERNAME_CLAIM = "preferred_username";
            OIDC_DISPLAY_NAME = self.private.misc.kanidm_display_name;
